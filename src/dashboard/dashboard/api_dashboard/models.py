...
class GameHistory(models.Model):
	...
	# user = models.ForeignKey('api_user.CustomUser', related_name='games_history', on_delete=models.CASCADE, default=1) # Provide a default user ID, otherwise the dashboard container keeps crashing #TEST CARO //HERE
