...
from .views import SendFriendRequestView, AcceptFriendRequestView, RejectFriendRequestView, RemoveFriendView, FriendRequestStatus, FriendRequestID, DeleteInactiveUsersFriendRequests, DeleteUserFriendRequests
...
urlpatterns = [
    ...
    path('DeleteUserFriendRequests/', DeleteUserFriendRequests.as_view(), name='delete_user_friend_requests'),
